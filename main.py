...
# Menu de opções
print ('-' * 40)
print('∷ MENU QUANTIDADE CORRETA POR DESTINO:')
print ('-' * 40)
...
# Loop para tratamento de erros adicionado
while True:
    opcao_linha = ler_numero ('Digite uma opção de 1 a 10: ')
    if 1 <= opcao_linha <= 10:
        break
    else:
         print("❌ Opção inválida. Escolha entre 1 e 10.")
...
if opcao_linha in (1, 2):
    quantidade_producao = ler_numero ('Quantas Bateladas?: ')
    peso_bag_sacaria_expedicao = ler_numero ('Qual o peso de cada bag?: ')
elif opcao_linha in (3, 4):
    quantidade_producao = ler_numero ('Qunatas bateladas?: ')
    peso_bag_sacaria_expedicao = ler_numero ('Qual o peso de cada sacaria?: ')
elif opcao_linha == 5:    
  quantidade_producao = ler_numero ('Qunatas bateladas?: ')
  peso_bag_sacaria_expedicao = ler_numero ('Qual o peso de cada sacaria?: ')
elif opcao_linha == 6:
  ...
  quantidade_producao = ler_numero ('Qunatas bateladas?: ')
  peso_bag_sacaria_expedicao = ler_numero ('Qual o peso de cada pacote?: ')
elif opcao_linha == 10:
  quantidade_producao = ler_numero ('Quantidade a ser carregada?: ')
  peso_bag_sacaria_expedicao = ler_numero ('Quantas caixas?: ')  
else:
...
try:
  ...
  print(f"\n❌ Ocorreu um erro inesperado durante o cálculo: {e}")
print() 